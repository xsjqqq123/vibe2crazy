# backend/app/websocket/matrix_terminal.py
import asyncio
import json
import pty
import os
...
class MatrixWebSocketTerminal:
    ...
    def __init__(self, websocket: WebSocket, session_name: str, index: int, initial_cols: int = SIZE_COLS, initial_rows: int = SIZE_ROWS):
    ...
    async def start(self):
        ...
        try:
            ...
            logger.info(f"Matrix terminal {self.index} PTY created: {self.cols}x{self.rows}")
